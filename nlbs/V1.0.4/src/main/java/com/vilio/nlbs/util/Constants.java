...
//    public final static String DISTRIBUTOR_VILIO_NAME = "上海宏获资产管理有限公司";
    ...
    /** 操作类型--补充进件材料 **/
    public final static String OPERATION_SUPPLEMENT = "04";
    /** 操作类型--提交评估 **/
    ...
    /* 待办任务类型 -- 进件申请 */
    public final static String TODO_TYPE_TOSUBMIT = "002";
    ...
    //BMS字典表，type
    public final static String BMS_DICTIONARY_LOAN_TERM = "loan_term";//借款期限
    public final static String BMS_DICTIONARY_LOAN_METHOD = "loan_method";//放款方式
    public final static String BMS_DICTIONARY_LOAN_MORTGAGED_TYPE = "loan_mortgaged_type";//抵押类型
    public final static String BMS_DICTIONARY_FILE_TYPE = "file_type";//进件材料类型


    //BMS部分进件状态
    public final static String BMS_APPLY_STATUS_PENDING_QUERY = "0081";//待查询产调
    public final static String BMS_APPLY_STATUS_CHECKING_LOANCONDITION = "0090";//待检查放款条件
    public final static String BMS_APPLY_STATUS_PENDING_LOAN = "0091";//待放款
    public final static String BMS_APPLY_STATUS_LOAN_SUCCESS = "0100";//授信成功
    public final static String BMS_APPLY_STATUS_REFUSE = "1002";//拒单
    public final static String BMS_APPLY_STATUS_CANCEL = "1001";//撤单
    public final static String BMS_APPLY_STATUS_DELETE = "1003";//作废

    //BMS婚姻状态
    public final static String BMS_MARITAL_STATUS_UNMARRIED = "01";// '未婚',
    public final static String BMS_MARITAL_STATUS_MARRIED = "02";// '已婚',
    public final static String BMS_MARITAL_STATUS_DIVORCE = "03";// '离异',
    public final static String BMS_MARITAL_STATUS_WIDOWED = "04";// '丧偶',
    public final static String BMS_MARITAL_STATUS_REMARRIAGE = "06";// '再婚',
}

...
public enum HHInterface {
    ...
    /** 调用贷后系统相关功能号---start **/
    HH_300009("plms300009", "贷款业务查询初始化接口"),
    HH_300010("plms300010", "贷款业务查询"),
    HH_300011("plms300011", "贷款业务详情查询"),
    HH_300012("plms300012", "还款计划查询初始化接口"),
    HH_300014("plms300014", "还款计划查看详情"),
    HH_300013("plms300013", "还款计划查询"),
    HH_300029("plms300029", "贷款业务查询-还款记录"),
    HH_300034("plms300034", "贷款业务查询-放款记录"),
    HH_300035("plms300035", "贷款业务查询-还款计划"),
    HH_300049("plms300049", "逾期记录查询初始化"),
    HH_300050("plms300050", "逾期记录列表查询"),
    HH_300060("plms300060", "查看逾期记录详细"),
    /** 调用贷后系统相关功能号---end **/

    HH_100001("HH100001", "查询渠道的录单员"),
    ;

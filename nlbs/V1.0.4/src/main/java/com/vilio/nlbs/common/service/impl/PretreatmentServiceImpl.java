        ...
        try {
            ...
            if (ReturnCode.SUCCESS_CODE.equals(headMap.get(Fields.PARAM_MESSAGE_ERR_CODE))) {
                ...
                switch (hhInterface) {
                    ...
                    /** 调用贷后系统接口 开始**/
                    case HH_300009:
                        serviceMap = plmsService.plms300009(bodyMap);
                        break;
                    case HH_300010:
                        serviceMap = plmsService.plms300010(bodyMap);
                        break;
                    case HH_300011:
                        serviceMap = plmsService.plms300011(bodyMap);
                        break;
                    case HH_300012:
                        serviceMap = plmsService.plms300012(bodyMap);
                        break;
                    case HH_300014:
                        serviceMap = plmsService.plms300014(bodyMap);
                        break;
                    case HH_300013:
                        serviceMap = plmsService.plms300013(bodyMap);
                        break;
                    case HH_300029:
                        serviceMap = plmsService.plms300029(bodyMap);
                        break;
                    case HH_300034:
                        serviceMap = plmsService.plms300034(bodyMap);
                        break;
                    case HH_300035:
                        serviceMap = plmsService.plms300035(bodyMap);
                        break;
                    case HH_300049:
                        serviceMap = plmsService.plms300049(bodyMap);
                        break;
                    case HH_300050:
                        serviceMap = plmsService.plms300050(bodyMap);
                        break;
                    case HH_300060:
                        serviceMap = plmsService.plms300060(bodyMap);
                        break;
                    /** 调用贷后系统接口 结束**/
                    case HH_100001:
                        serviceMap = commonService.queryRecordsByDistributorCode(bodyMap);
                        break;

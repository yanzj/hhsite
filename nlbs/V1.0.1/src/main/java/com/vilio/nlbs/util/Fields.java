...
public class Fields {
    ...
    /** 系统内部参数传递--keyAddress **/
    public final static String PARAM_MSG_KEY_ADDRESS = "keyAddress";
    ...
    /* 人员--有效期 */
    public final static String PARAM_PERSON_PERIOD_OF_VALIDITY = "periodOfValidity";
    /* 人员--移动电话 */
    ...
    /* 附记 */
    public final static String PARAM_MORTGAGE_REMARK = "remark";
    /* 产调信息列表 */

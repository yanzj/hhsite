            ...
            if (ReturnCode.SUCCESS_CODE.equals(headMap.get(Fields.PARAM_MESSAGE_ERR_CODE))) {
                ...
                switch (hhInterface) {
                    ...
                    case HH_CHANGEPSW_FIRSTLOGIN:
                        ...
                        break;
                    case HH_CHANGE_USER_INFO:
                        serviceMap = loginService.changeInfo(bodyMap);
                        break;
                    case HH_USER_LOGOUT:
                    ...
                    case HH_GETLIST_MATERIAL_TYPE:
                        ...
                        break;
                    case HH_GETLIST_APPLY_RECORD_STATUS:
                        serviceMap = applyService.queryAllApplyRecordStatusList();
                        break;
                    case HH_INIT_SUPPLY_APPLY_MATERIAL:
                        serviceMap = applyService.initSupplyApplyMaterial(bodyMap);
                        break;

...
//            }
    ...
    private boolean isFilterRequest(String functionNo) {
        ...
        if (HHInterface.HH_USER_LOGIN.getFunctionNo().equals(functionNo) || HHInterface.HH_RECEIVE_MESSAGE.getFunctionNo().equals(functionNo) || HHInterface.HH_UPDATE_INQUIRY_RESULT.getFunctionNo().equals(functionNo)) {
            return true;
        }

DROP TABLE IF EXISTS `pcfs_login_info`;
CREATE TABLE `pcfs_login_info` (
  ...
  `first_login` varchar(2) DEFAULT NULL COMMENT '首次登录',
  ...
  `trans_pwd_flag` varchar(2) DEFAULT NULL COMMENT '交易密码是否存在标识：0-不存在 1-存在',
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='登录信息表';


DROP TABLE IF EXISTS `pcfs_verify_info`;
CREATE TABLE `pcfs_verify_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `verify_serno` varchar(40) NOT NULL COMMENT '流水',
  `mobile_no` varchar(18) NOT NULL,
  `verify_code` varchar(10) NOT NULL COMMENT '验证码',
  `verify_type` varchar(10) NOT NULL COMMENT '验证码类型（00-登录验证码）',
  `effective_time` varchar(40) NOT NULL COMMENT '有效时间',
  `sign_no` varchar(40) NOT NULL,
  `template_no` varchar(40) NOT NULL,
  `status` varchar(5) DEFAULT NULL,
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `remark1` varchar(100) DEFAULT NULL COMMENT '备注1',
  `remartk2` varchar(100) DEFAULT NULL COMMENT '备注2',
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_serno` (`verify_serno`)

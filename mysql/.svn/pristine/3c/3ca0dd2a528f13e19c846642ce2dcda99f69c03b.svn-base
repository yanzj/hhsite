...
insert into bms_user_distributor (code,distributor_code,user_no) values (UUID(),'00000011','15921228421');
insert into bms_user_distributor (code,distributor_code,user_no) values (UUID(),'00000011','15021000149');
insert into bms_user_distributor (code,distributor_code,user_no) values (UUID(),'00000011','13817403697');
insert into bms_user_distributor (code,distributor_code,user_no) values (UUID(),'00000011','18721675945');
insert into bms_user_distributor (code,distributor_code,user_no) values (UUID(),'00000011','15202190793');
insert into bms_user_distributor (code,distributor_code,user_no) values (UUID(),'00000011','18721176924');
insert into bms_user_distributor (code,distributor_code,user_no) values (UUID(),'00000011','13917228473');
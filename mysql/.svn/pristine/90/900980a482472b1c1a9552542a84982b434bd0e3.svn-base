...
#给陈晨、朱琳、邓桂萍经纪人角色
INSERT INTO bms_role_user(code,role_code,user_no) values (uuid(),'891','18217279902');
INSERT INTO bms_role_user(code,role_code,user_no) values (uuid(),'891','15026781572');
INSERT INTO bms_role_user(code,role_code,user_no) values (uuid(),'891','15201918896');

#给李勇总经理角色
INSERT INTO bms_role_user(code,role_code,user_no) values (uuid(),'894','13564169229');

#层级架构
insert into bms_user_hierarchy (code,user_no,parent_user_no) values (UUID(),'18217279902','13564169229');
insert into bms_user_hierarchy (code,user_no,parent_user_no) values (UUID(),'15026781572','13564169229');
insert into bms_user_hierarchy (code,user_no,parent_user_no) values (UUID(),'15201918896','13564169229');
insert into bms_user_hierarchy (code,user_no,parent_user_no) values (UUID(),'13564169229','13564169229');
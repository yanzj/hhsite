...
public class HttpUtil {
	 ...
	 */
	public String sendHttp(String url, Map<String, Object> params) throws ErrorException {
	 ...
	 * @throws ErrorException
	 */
	private String sendHttp(String url, Map<String, Object> params, int REQUEST_TIMEOUT, int SO_TIMEOUT)
			throws ErrorException {
		...
		try {
			...
			throw new ErrorException("SYS9998", "网络连接超时!");
		} catch (ClientProtocolException e) {
			log.error("HttpClientUtils：网络出现异常" + e.getMessage());
			throw new ErrorException("SYS9998", "网络出现异常!");
		} catch (IOException e) {
			log.error("HttpClientUtils：网络出现异常" + e.getMessage());
			throw new ErrorException("SYS9998", "网络出现异常!");
			...
			throw new ErrorException("SYS9999", "");
		} finally {
	 ...
	 * @throws ErrorException
	 */
	public String sendHttp(String url, String content) throws ErrorException {
	 ...
	 * @throws ErrorException
	 */
	private String sendHttp(String url, String content, int REQUEST_TIMEOUT, int SO_TIMEOUT) throws ErrorException {
	 ...
	 * @throws ErrorException
	 */
	public String sendHttps(String url, Map<String, Object> params, String method) throws ErrorException {
	 ...
	 * @throws ErrorException
	 */
	public String sendHttps(String url, Map<String, Object> params, String method, int REQUEST_TIMEOUT, int SO_TIMEOUT,

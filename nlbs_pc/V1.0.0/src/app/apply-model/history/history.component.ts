...
export class HistoryComponent implements OnInit {
  ...
  historyoperationList(){
    ...
    var bmsLoanCode = this.commonFunc.handleNilString(businessObj.bmsLoanCode);
  ...
  querysubLink(){
    this.router.navigate(['/home/apply-model'])
  }
  itemDetails(){
...
//根据状态显示面包屑的不同显示问题
  isdisplayqueryLinkfun(){
      if(this.commonFunc.getBusinessData().statusName=="暂存"){

...
@Component({
  selector: 'app-lended-query',
  templateUrl: './lended-query.component.html',
  styleUrls: ['./lended-query.component.css']
})
export class LendedQueryComponent implements OnInit {
...
//贷款业务查询列表接口
  ...
  onSecondOperationClick(item) {
    this.router.navigate(['/home/lendedQuery', item.contractCode])//;

...
@Component({
  selector: 'app-repayment-record-view',
  templateUrl: './repayment-record-view.component.html',
  styleUrls: ['./../../lended-query-detail.component.css','./repayment-record-view.component.css']
})
export class RepaymentRecordViewComponent implements OnInit {

  @Input() detailPageShow:boolean;
  @Input() receiptsRecordList:any={};

  @Input() currentItemLists:any={};

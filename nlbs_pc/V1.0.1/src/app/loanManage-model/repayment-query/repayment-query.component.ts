...
@Component({
  selector: 'app-repayment-query',
  templateUrl: './repayment-query.component.html',
  styleUrls: ['./repayment-query.component.css']
})
export class RepaymentQueryComponent implements OnInit {

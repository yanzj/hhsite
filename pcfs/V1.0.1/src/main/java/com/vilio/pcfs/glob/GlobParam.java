...
public class GlobParam {
    ...
    public static String pushType = "Umeng";
    public static String pushSenderIdentityId = "pcfs001";
    public static String pushFunctionNo = "HH000804";
    public static String pushAndroidAppCode = "3000000000000000002";
    public static String pushIosAppCode = "3000000000000000001";
    ...
    /* 文件系统路径 */
    public static String fmsUrl = "http://192.168.0.4:8081/fms/api/fileLoad/uploadFile";
    /* 文件系统路径 */
    ...
    /* 修改信息 */
    public final static String umUpdateUserInfo = "200006";

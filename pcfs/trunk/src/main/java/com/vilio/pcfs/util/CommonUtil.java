...
public class CommonUtil {
     ...
     * @throws ErrorException
     */
    public static void checkField(String field ,String name , Integer needLength,Integer maxLength) throws ErrorException {
        if(field  == null || field.length() == 0) {
            throw new ErrorException(ReturnCode.REQUIRED_FIELD_MISSING,"缺少必要参数,或数据格式不正确") ;
        }
        if (needLength != null) {

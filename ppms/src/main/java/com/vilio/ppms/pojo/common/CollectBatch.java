...
public class CollectBatch {
    ...
    public CollectBatch(Long id, String code, String sysSerno, String transType, String reqFileName, String reqFileId, Long totalCount, BigDecimal totalAmount, Long succCount, BigDecimal succAmount, Long failCount, BigDecimal failAmount, Long unsettledCount, BigDecimal unsettledAmount, String batchStatus, String respFileName, String respFileId, Date respTime, String respCount, String respCode, String respMsg, String status, Date createTime, Date updateTime, String remark1) {
        this.id = id;
        this.code = code;
    ...
    public void setRespCount(String respCount) {
        this.respCount = respCount == null ? null : respCount.trim();
    }

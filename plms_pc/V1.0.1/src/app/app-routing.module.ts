...
const routes: Routes = [
  ...
  },
  {
    ...
    children:[
      ...
      {
        path:'repaymentSchedule',//还款计划查询
        component:RepaymentScheduleQueryComponent,
      },
      {
        path:'repaymentSchedule/:id',//还款计划查询详情
      ...
      {
        path:'accountInfo/:id',//账户信息查询详情
        component:AccountInfoDetailComponent
      },
      //资金管理
      {
        path:'repaymentRegisterQuery',//还款到账登记
        component:RepaymentRegisterQueryComponent
      },
      {
        path:'repaymentRegisterQuery/:id',//还款到账登记查看详情
        component:CheckRepaymentComponent
      },
      {
        path:'repaymentAccountModify',//还款到账修改
        component:RepaymentAccountModifyComponent
      },
      {
        path:'repaymentAccountModify/:id',//还款到账修改
        component:RepaymentAccountDetailComponent
      },
      //运营管理
      {
        path:'repaymentPlanConfirmation', //还款计划确认
        component:RepaymentPlanConfirmationComponent,
      },
      {
        path:'repaymentPlanConfirmation/:id',//还款计划确查看认详情
        component:RepaymentPlanDetailComponent,
      },
      {
        path:'repaymentPlanModifyQuery',//还款计划修改
        component:RepaymentPlanModifyQueryComponent
      },
      {
        path:'repaymentPlanModifyQuery/:id',
        component:RepaymentPlanModifyDetailComponent
      },
      {
        path:'repaymentRegisterQuery/repayment-register-detail/selectLoan',//选择借款合同
        component:SelectLoanContractComponent
      },
      {
        path:'repaymentRegisterQuery/repayment-register-detail/selectLoan/:id',//人工登记
        component:ManualRegistrationComponent
      },
      {
        path:'repaymentRegisterQuery/batch-upload/batchUpload',//批量上传

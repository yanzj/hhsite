...
import {loanBusinessDetailService} from "../loan-business-detail/loan-business-detail.service";
// import {win} from "@angular/platform-browser/src/facade/browser";
// 申请查询
declare var $: any;
declare var laydate: any;
@Component({
  selector: 'app-loan-business-query',
  templateUrl: './loan-business-query.component.html',
  styleUrls: ['./loan-business-query.component.css'],
  providers: [loanBusinessDetailService]
})
export class LoanBusinessQueryComponent implements OnInit {

  constructor(private loanBusinessDetail: loanBusinessDetailService,
...
//贷款业务查询列表接口
  ...
  onSecondOperationClick(item) {
    ...
    // this.loanBusinessDetail.tabHighLight='01';
    window.sessionStorage.setItem('tabHighLight','01');
    window.sessionStorage.setItem('backPath','loanBusiness');
  }
}

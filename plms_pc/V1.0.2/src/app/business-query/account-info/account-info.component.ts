...
export class AccountInfoComponent implements OnInit {
  ...
  getSearchCondigtion() {
    ...
    var agent=this.commonFunc.handleNilString($("#agent").val());//业务经理
  ...
  QueryEntryList=() =>{
    ...
    var Obj = {
      ...
      'body': {
        ...
        'agentName': searchConditions.agent,
  ...
  linkCheckUpLoan(item){
    ...
    window.sessionStorage.setItem('backPath','accountInfo');
    this.paidInfoCode=item.paidInfoCode;

  }

  modifyFunc(item){
    this.router.navigate(['/home/accountInfo', item.contractCode])//;
  }

...
declare var $: any;
@Component({
  selector: 'app-debit-record',
  templateUrl: './debit-record.component.html',
  styleUrls: ['./debit-record.component.css'],
})
export class DebitRecordComponent implements OnInit {

...
declare var $: any;
@Component({
  selector: 'app-record-lending',
  templateUrl: './record-lending.component.html',
  styleUrls: ['./record-lending.component.css']
})
export class RecordLendingComponent implements OnInit {
  ...
  readDetail(item){
    this.recordDetailPageShow=true;
    this.event.emit(this.recordDetailPageShow);
    this.paidInfoDetail=item;
   // this.meterialNumberFunc(item.fileList)
  }

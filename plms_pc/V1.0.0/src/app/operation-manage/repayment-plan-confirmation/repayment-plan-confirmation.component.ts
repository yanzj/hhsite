...
@Component({
  selector: 'app-repayment-plan-confirmation',
  templateUrl: './repayment-plan-confirmation.component.html',
  styleUrls: ['./repayment-plan-confirmation.component.css']
})
export class RepaymentPlanConfirmationComponent implements OnInit {
    ...
    $.getScript("/assets/js/laydate/laydate.js").then(function () {
      ...
      var start = {
        ...
        choose: function (datas) {
          ...
          console.log('..........................................',$('#applyTimeBegin').val())
        }
      };
      var end = {
        elem: '#applyTimeEnd',
...
//贷款业务查询列表接口
  ...
  onSecondOperationClick(item){
    this.router.navigate(['/home/repaymentPlanConfirmation', item.contractCode])//;

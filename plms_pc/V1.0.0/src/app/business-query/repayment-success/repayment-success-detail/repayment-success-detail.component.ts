...
@Component({
  selector: 'app-repayment-success-detail',
  templateUrl: './repayment-success-detail.component.html',
  styleUrls: ['./repayment-success-detail.component.css']
})
export class RepaymentSuccessDetailComponent implements OnInit {
...
//判断文件的类型
  ...
  querySection(){
    this.router.navigate(['/home/repaymentSuccess'])
  }
}

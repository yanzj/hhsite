 ...
 * 说明：<br>
 */
public class UmUnLockJob extends QuartzJobBean {

    private static Logger logger = Logger.getLogger(UmUnLockJob.class);
    ...
    public void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        try {
            ...
            UmUserDao umUserDao = (UmUserDao) skedCtx.get("umUserDao");
            String unLockTime = GlobParam.umHashLockTime;
            ...
            //锁定的用户超过阈值解锁
            int ret = umUserDao.updateUnLock(updateParam);
            if (ret>0){

...
public class RollBackPaymentAndOverdueService {
     ...
     * @param contractCode
     */
    public void mainJob(String rollBachDate, String contractCode) throws ErrorException, ParseException {
        ...
        for (PlmsRepaymentScheduleDetail repaymentScheduleDetail : repaymentScheduleDetails) {
            ...
            //回滚扣款
            Map paymentTotal = rollBackPayment(repaymentScheduleDetail, rollBachDate);
     ...
     * @param rollBachDate
     */
    private Map rollBackPayment(PlmsRepaymentScheduleDetail repaymentScheduleDetail, String rollBachDate) throws ErrorException {
        //查询还款明细记录
        ...
        //将关联的所有罚息信息标记成未结清
        int ret = overdueDao.updateOverdueStatusByRepaymentDetailCodeBatch(repaymentDetails);
        if (ret < 0) {
            //等于0是正常现象
            throw new ErrorException(ReturnCode.UPDATE_FAIL, "");
        }

...
public class RollbackAndRecomputationProxy {
     ...
     * @throws Throwable
     */
    public void updateAccountUnLockForParam(String rollBachDate, String contractCode) throws Throwable {
        updateAccountUnLock();
    }
    ...
    public void rollBackPaymentAndOverdue(String rollBachDate, String contractCode) throws Throwable {
    ...
    @Transactional(propagation = Propagation.REQUIRED,
            isolation = Isolation.READ_COMMITTED,
            rollbackFor = Exception.class)
    public void accountLockRollBackPaymentAndOverdue(String rollBachDate, String contractCode) throws Throwable {
        updateAccountLock();
        rollBackPaymentAndOverdue(rollBachDate, contractCode);
    }
    ...
    @Transactional(propagation = Propagation.REQUIRED,
            isolation = Isolation.READ_COMMITTED,
            rollbackFor = Exception.class)
    public void accountUnLockRecomputationPaymentAndOverdue(String rollBachDate, String contractCode) throws Throwable {
        recomputationPaymentAndOverdue(rollBachDate, contractCode);
        updateAccountUnLock();
    }
    ...
    @Transactional(propagation = Propagation.REQUIRED,
            isolation = Isolation.READ_COMMITTED,
            rollbackFor = Exception.class)
    public void recomputationPaymentAndOverdue(String rollBachDate, String contractCode) throws Throwable {
        if (rollBachDate.length() != 10) {
            throw new ErrorException(ReturnCode.REQUIRED_FIELD_MISSING, "日期格式不正确");
        }
        String paymentDate = DateUtil.getDaysDate2(rollBachDate, 1);
        recomputationPaymentAndOverdueService.mainJob(paymentDate, contractCode);

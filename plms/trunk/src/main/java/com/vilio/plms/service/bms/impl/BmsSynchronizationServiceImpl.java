...
//        JSONObject json = JSONObject.fromObject(jsonString);
        ...
        if (BMSLoanCode != null && !"".equals(BMSLoanCode)) {
            ...
            if (plmApplyInfo == null) {
                ...
                //资方信息
                Map fundSideInfo = (Map) map.get("fundSideInfo");

                //资方产品信息
                Map fundSideProductInfo = (Map) map.get("fundSideProductInfo");
                ...
                Integer interestCollectionDate = (Integer) interestCollectionMethodMap.get("interestDate");
...
//                String paidDaysComputationalRule = GlobDict.product_paid_days_computational_rule_both.getKey();
                ...
                //资方产品名称
                String fundSideProductName = (String) fundSideProductInfo.get("productName");
                Map fundSideReq = new HashedMap();
                fundSideReq.put("bmsCode", organizationCode);
                fundSideReq.put("productName", fundSideProductName);
                ...
                String paidDaysComputationalRule = (String)fundSideProduct.get("paidDaysComputationalRule");

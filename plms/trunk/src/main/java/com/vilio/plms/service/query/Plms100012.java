 ...
 */
@Service
public class Plms100012 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100012.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        //获取收款方列表
        List payeeList = commonService.queryPayeeList();
        resultMap.put(Fields.PARAM_PAYEE_LIST, payeeList);
    }

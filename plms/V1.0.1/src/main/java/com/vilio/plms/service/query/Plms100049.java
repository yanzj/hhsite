 ...
 */
@Service
public class Plms100049 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100049.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        //状态列表
        resultMap.put("repaymentScheduleStatusList", commonService.queryRepaymentScheduleStatusList());

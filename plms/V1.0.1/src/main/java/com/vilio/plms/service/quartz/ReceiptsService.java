...
public class ReceiptsService extends BaseService {
    ...
    public void receipts() throws ErrorException {
        ...
        for (ReceiptsRecord receiptsRecord : receiptsRecords) {
            try {
                ((ReceiptsService) AopContext.currentProxy()).receiptsSingleTrans(receiptsRecord.getReceiptsDate(), receiptsRecord.getContractCode(), receiptsRecord);
                //执行成功，更改状态为处理成功
    ...
    public void receiptsSingleTrans(String rollBachDate, String contractCode, ReceiptsRecord receiptsRecord) throws ErrorException, ParseException, Exception {
        ((ReceiptsService) AopContext.currentProxy()).receiptsSingle(rollBachDate, contractCode, receiptsRecord);
    }
     ...
     */
    public void receiptsSingle(String rollBachDate, String contractCode, ReceiptsRecord receiptsRecord) throws ErrorException, ParseException, Exception {
        //查询当前账户明细

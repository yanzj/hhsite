 ...
 */
@Service
public class Plms100031 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100031.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        resultMap.put("applyInfo",queryService.queryApplyInfo(body));
    }

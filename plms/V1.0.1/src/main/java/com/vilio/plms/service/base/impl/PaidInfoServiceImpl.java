...
public class PaidInfoServiceImpl implements PaidInfoService {
    ...
    public void cancelPaidInfo(String paidCode) throws Exception {
        ...
        /**
         回滚逾期，回滚扣款
         */
        rollBackPaymentAndOverdueService.mainJob(strPaidTime, contractCode);
        /**
         删除放款
         */
        //1.更新借款信息为放款中
        ...
        //yyyy-MM-dd
        recomputationPaymentAndOverdueService.mainJob(DateUtil.formatDateTime(DateUtil.parseDate(paymentDate), DateUtil.DATE_PATTERN2), contractCode);
    }

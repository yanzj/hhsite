 ...
 */
@Service
public class Plms100035 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100035.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        map.put("repaymentScheduleStatus",accountDetail.getConfirmed());
        map.put("repaymentScheduleStatusName","02".equals(accountDetail.getConfirmed())?"已确认":"未确认");

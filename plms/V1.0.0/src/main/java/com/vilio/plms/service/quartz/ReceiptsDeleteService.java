...
public class ReceiptsDeleteService extends BaseService {
    ...
    private void receiptsDelete() throws ErrorException {
        ...
        for (ReceiptsRecord receiptsRecord : receiptsRecords) {
            try {
                ((ReceiptsDeleteService) AopContext.currentProxy()).receiptsDeteleSingleTrans(receiptsRecord);
                //删除资金入账记录
    ...
    public void receiptsDeteleSingleTrans(ReceiptsRecord receiptsRecord) throws ErrorException, ParseException, Exception {
        ((ReceiptsDeleteService) AopContext.currentProxy()).receiptsDeteleSingle(receiptsRecord.getReceiptsDate(), receiptsRecord.getContractCode(), receiptsRecord);
    }
    ...
    public void receiptsDeteleSingle(String rollBachDate, String contractCode, ReceiptsRecord receiptsRecord) throws ErrorException, ParseException, Exception {
        //扣减账户余额

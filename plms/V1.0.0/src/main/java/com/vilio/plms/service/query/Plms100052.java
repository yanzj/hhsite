 ...
 */
@Service
public class Plms100052 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100052.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        List list = queryDao.queryPaidInfoList(body);

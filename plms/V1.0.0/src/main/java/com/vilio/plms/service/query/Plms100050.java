 ...
 */
@Service
public class Plms100050 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100050.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        List list = queryDao.queryOverDueRepaymentScheduleList(body);

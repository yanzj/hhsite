 ...
 */
@Service
public class Plms100028 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100028.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        List dataList = queryDao.queryRepaymentDetailListByContractCode(body);

        ...
        if(umResultMap != null){
            ...
            if(ReturnCode.SUCCESS_CODE.equals(errCode)){
                ...
                if(groupInfo != null){
                    ...
                    resultMap.put(Fields.PARAM_DISTRIBUTRO_CODE, groupInfo.get(Fields.PARAM_GROUP_ID));
                    resultMap.put(Fields.PARAM_DISTRIBUTRO_NAME, groupInfo.get(Fields.PARAM_GROUP_NAME));

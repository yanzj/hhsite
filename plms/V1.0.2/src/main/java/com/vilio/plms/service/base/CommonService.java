...
public class CommonService {
    ...
    */
    ...
    public Map buildRepaymentScheduleDetail(Date borrowEndDate, String paidCode) throws Exception {
        ...
        BigDecimal paidInfoBailAmount = new BigDecimal(paidInfo.getBail());
        ...
        BigDecimal accountDetailBailAmount = new BigDecimal(accountDetail.getBail());
        ...
        BigDecimal accountBailAmount = new BigDecimal(account.getBail());
        ...
        for (int i = 0; i < scheduleDetailList.size(); i++) {
            ...
            BigDecimal interest = detail.getInterest().setScale(2,BigDecimal.ROUND_HALF_UP);
            BigDecimal serviceFee = detail.getServiceFee().setScale(2,BigDecimal.ROUND_HALF_UP);
            BigDecimal bailAmount = detail.getBail().setScale(2,BigDecimal.ROUND_HALF_UP);
            ...
            paidInfoBailAmount = paidInfoBailAmount.add(bailAmount);
        ...
        paidInfo.setBail(paidInfoBailAmount.toString());

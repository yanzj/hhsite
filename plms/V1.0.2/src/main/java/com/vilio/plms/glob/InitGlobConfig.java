...
public class InitGlobConfig extends HttpServlet {
    ...
    public void setConfigProperties(Map configProperties) {
        ...
        GlobParam.mpsInstationFunctionNo = configProperties.get("mps.instation.functionNo").toString();
        GlobParam.mpsInstationType = configProperties.get("mps.instation.type").toString();
        ...
        GlobParam.systemEmailManagentName = configProperties.get("systemEmailManagentName").toString();
        GlobParam.systemManagentEmailUserName = configProperties.get("systemManagentEmailUserName").toString();
        GlobParam.systemManagentEmailPassword = configProperties.get("systemManagentEmailPassword").toString();

 ...
 */
@Service
public class Plms100057 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100057.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        //科目列表
        resultMap.put("subjectList", commonService.querySubjectList());

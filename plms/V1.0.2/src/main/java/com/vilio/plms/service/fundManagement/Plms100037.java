 ...
 */
@Service
public class Plms100037 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100037.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        List list = fundManagerDao.queryReceiptsRecordList(body);

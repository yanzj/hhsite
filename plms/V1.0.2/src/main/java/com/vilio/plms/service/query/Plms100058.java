 ...
 */
@Service
public class Plms100058 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100058.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        List list = queryDao.queryRepaymentDetailList(body);

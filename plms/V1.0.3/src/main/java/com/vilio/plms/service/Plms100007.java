 ...
 */
@Service
public class Plms100007 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100007.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        Map<String, Object> result = todoService.getTodoTaskList(body);

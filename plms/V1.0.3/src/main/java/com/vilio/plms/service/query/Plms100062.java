 ...
 */
@Service
public class Plms100062 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100062.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        List list = queryDao.queryAccountDetailList(body);

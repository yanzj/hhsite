 ...
 */
@Service
public class Plms100006 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms100006.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        Map<String, Object> result = todoService.initTodoTaskList();

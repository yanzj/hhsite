 ...
 */
@Service
public class Plms300013 extends BaseService {

    private static final Logger logger = Logger.getLogger(Plms300013.class);
    ...
    public void busiService(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException, Exception {
        ...
        List list = queryForNlbsDao.queryRepaymentScheduleList(body);

...
public class SmsHH000803 extends BaseService {
    ...
    public void busiServiceNoTransaction(Map<String, Object> head, Map<String, Object> body, Map<String, Object> resultMap) throws ErrorException {
        ...
        ((SmsHH000803) AopContext.currentProxy()).insertMsg(body, serialNo, sign, template);
        //开始发送短信
        ...
        //修改主表和短信表的状态
        ((SmsHH000803) AopContext.currentProxy()).updateMsgStatus(serialNo, result);
    ...
    public void updateMsgStatus(String serialNo, Map result) throws ErrorException {
        ...
        smsUpdateParam.setSendStatus(result.get("sendStatus").toString());
    ...
    @Transactional(propagation = Propagation.REQUIRED,
            isolation = Isolation.READ_COMMITTED,
            rollbackFor = Exception.class)
    public void insertMsg(Map<String, Object> body, String serialNo, Sign sign, Template template) throws ErrorException {
        Map templateParam = (Map) body.get("templateParam");
        ...
        //状态初始化成功
        smsInserParam.setSendStatus(GlobDict.send_init.getKey());

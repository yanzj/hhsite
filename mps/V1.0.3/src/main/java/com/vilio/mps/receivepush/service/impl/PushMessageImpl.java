...
public class PushMessageImpl implements PushMessage {
    ...
    public Map pushMessageToPlms(Map paramMap) throws Exception {
        ...
        Map<String, Object> headMap = new HashMap<String, Object>();
        Map<String, Object> bodyMap = new HashMap<String, Object>();
        headMap.put(Fields.PARAM_FUNCTION_NO, "Plms400001");
        ...
        //发送消息
        JSONObject jsonParam = JSONObject.fromObject(requestMap);
        JSONObject   resultJson = HttpRequestUtils.httpPost(ConfigInfo.plmsUrl ,jsonParam);
        ...
        for(NlbsMessageResp message:listMessageResp){
            ...
            receiverMap.put(Fields.PARAM_MPS_RECEIVERNAME, message.getReceiverName());
            receiverMap.put(Fields.PARAM_MPS_RECEIVER_CODE, message.getCode());
            receiverMap.put(Fields.PARAM_MPS_RECEIVERSYSTEM, Constants.RECEIVER_SYSTEM_PLMS);
            receiverList.add(receiverMap);
        }

...
public class Sms {
    ...
    public Sms(Integer id, String serialNo, String innerSignNo, String innerTemplateCode, String templateParam, String outId, String receiptNo, String chlRetCode, String chlRetMsg, String timelyNews, String content, String mobile, String status, String sendNum, String lockNo, String createTime) {
        this.id = id;
        this.serialNo = serialNo;
        this.innerSignNo = innerSignNo;
        this.innerTemplateCode = innerTemplateCode;

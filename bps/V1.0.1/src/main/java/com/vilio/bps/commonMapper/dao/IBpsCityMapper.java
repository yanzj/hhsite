 ...
 * @技术服务 www.fwjava.com
 */
public interface IBpsCityMapper {
     ...
     */
    public void getInsert(BpsCity bpsCity) throws Exception;
     ...
     * @throws Exception  - 异常捕捉
     */
    public int getUpdate(BpsCity bpsCity) throws Exception;
     ...
     * @throws Exception  - 异常捕捉
     */
    public BpsCity getBean(Integer id) throws Exception;
    public BpsCity getBeanByCode(String code) throws Exception;
     ...
     * @param bpsCity         - 城市表
     * @return List<BpsCity>  - 执行结果
     * @throws Exception      - 异常捕捉
     */
    public List<BpsCity> getList(BpsCity bpsCity) throws Exception;
    public List<BpsCity> getListPrmMapRtnBean(Map<String, Object> map) throws Exception;
     ...
     * @throws Exception  - 异常捕捉
     */
    public int getCheckBy(BpsCity bpsCity) throws Exception;
    public int getCheckByPrmMap(Map<String, Object> map) throws Exception;
    //获取状态为1的所有城市
    List<BpsCity> queryAllCity() throws Exception;

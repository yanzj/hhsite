...
public class HttpRequestUtils {
     ...
     * @return
     */
    public static Object httpPost_obj(String url, Map<String,String[]> param, Map<String, String> headers, boolean noNeedResponse){
        //post请求返回结果
    ...
    public static Object httpGet(String url, Map<String, String> headers){
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                //只针对城市的接口，对出参进行特殊处理，世联不做处理
                if(!url.contains(ConfigInfo.urlContains)) {
                    //城市接口个性化
                    if (strResult != null && strResult.contains("\\\"")) {
                        strResult = strResult.replace("\\", "");
                    }

package com.vilio.fms.fileLoad.util;
...
public class ImageUtils {
    ...
    public static ImageUtils getImageHelper() {
        if (imageHelper == null) {
     ...
     *      缩放比例，如1.2
     */
    public static String scaleImage(InputStream inputStream,
                                  String destinationPath, double scale,String format) {
    ...
    public static void main(String[] args) {
        scaleImage("E:\\需求/woman.jpg", "E:\\需求/woman_001.png" ,0.3, "png");
    }

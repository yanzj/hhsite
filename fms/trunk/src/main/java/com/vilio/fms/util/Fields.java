...
public class Fields {
    ...
    /* 参数传递消息，消息体信息 */
    public final static String PARAM_MESSAGE_DATA = "data";
    /* 字段 文件模版名称 */
    public final static String PARAM_FILE_MODEL_NAME = "fileModelName";
    /* 字段 文件编码 */
    public final static String PARAM_FILE_CODE = "fileCode";
    ...
    /* 参数 客户方字段ID */
    public final static String PARAM_CUSTOMER_FIELD_ID = "customerFieldId";
    /* 参数 用户No */
    ...
    /* 参数 押息期数 */
    public final static String PARAM_CHARGE_INTEREST_TERM = "chargeInterestTerm";
    /* 参数 抵押物批复额度 */
    public final static String PARAM_APPROVAL_AMOUNT = "approvalAmount";
    /* 参数 产品-最高可贷额度 */
    ...
    /* 排序序号 */
    public final static String PARAM_ORDER_NO = "orderNo";
    /* 消息类型 */
    ...
    public final static String PARAM_LIST_DTO_ARRAYLIST = "listDtoArrayList";
    /** 文件所属类型 **/
    ...
    //请求参数 ：询价发起系统
    public final static String PARAM_INQUIRY_SOURCE_SYSTEM = "sourceSystem";
    //请求参数 ：询价用户——所在公司id
    public final static String PARAM_INQUIRY_USER_COMPANYID = "companyId";
    //请求参数 ：询价用户——所在公司名称
    public final static String PARAM_INQUIRY_USER_COMPANYNAME = "companyName";
    //请求参数 ：询价用户——所在部门id
    public final static String PARAM_INQUIRY_USER_DEPARTMENTID = "departmentId";
    //请求参数 ：询价用户——所在部门名称
    public final static String PARAM_INQUIRY_USER_DEPARTMENTNAME = "departmentName";
    //请求参数 ：询价用户——用户名
    public final static String PARAM_INQUIRY_USER_USERNAME = "userName";
    //请求参数 ：询价用户——用户id
    public final static String PARAM_INQUIRY_USER_USERID = "userId";
    //请求参数 ：文件序列号
    public final static String PARAM_INQUIRY_FILE_SERIAL_NO = "fileSerialNo";
    ...
    //返回参数 ：单个估价公司的估值
    public final static String PARAM_ASSESSMENT_COMPANY_PRICE = "price";
    //返回参数 ：单个估价公司的单价
    public final static String PARAM_ASSESSMENT_COMPANY_UNIT_PRICE = "unitPrice";
    /* 返回渲染模型 */
    public final static String PARAM_MODEL_TYPE = "modelType";

    //价格列表
    public final static String PARAM_PRICE_LIST = "priceList";

    //当前估价差价百分比
    public final static String PARAM_CURRENT_PERCENT = "currentPercent";
    //算法
    public final static String PARAM_ALGORITHM = "algorithm";

    //总楼层
    public final static String PARAM_TOTAL_FLOOR = "totalFloor";
    //当前层
    public final static String PARAM_CURRENT_FLOOR = "currentFloor";


    //询价流水号前缀
    public final static String INQUIRY_SERIAL_NO_PREFIX = "BPS-";
    //询价流水号后缀
    public final static String INQUIRY_SERIAL_NO_SUFFIX = null;
    //询价单个公司请求CODE前缀
    public final static String INQUIRY_APPLY_CODE_PREFIX = "A-";
    //询价单个公司请求CODE后缀
    public final static String INQUIRY_APPLY_CODE_SUFFIX = null;
    //询价单个公司图片CODE前缀
    public final static String INQUIRY_PICTURE_CODE_PREFIX = "P";
    //询价单个公司图片CODE后缀
    public final static String INQUIRY_PICTURE_CODE_SUFFIX = null;

    //失效时间
    public final static String PARAM_DEADLINE = "deadline";
    //出值时间
    public final static String PARAM_PRICE_TIME = "priceTime";
    ...
    //文件-文件序列号
    public final static String PARAM_FILE_NO = "fileNo";
    //文件-文件上传时间
    public final static String PARAM_FILE_UPLOAD_TIME = "fileUploadTime";


    //模版编码
    public final static String PARAM_MODEL_CODE = "modelCode";
    //创建者机构编码
    public final static String PARAM_PARTNER_GROUP_CODE = "partnerGroupCode";
    //创建者编码
    public final static String PARAM_PARTNER_CODE = "partnerCode";
    //创建者姓名
    public final static String PARAM_PARTNER_NAME = "partnerName";
    //模板文件CODE
    public final static String PARAM_MODEL_FILE_CODE = "modelFileCode";
    //模板文件名称
    public final static String PARAM_MODEL_FILE_NAME = "modelFileName";
    //模板名称
    public final static String PARAM_MODEL_NAME = "modelName";
    //文件后缀
    public final static String PARAM_FILE_SUFFIX = "fileSuffix";
    //是否需要外发
    public final static String PARAM_NEED_OUT_SEND = "needOutSend";
    //对应接口功能号
    public final static String PARAM_SERVICE_FUNCTION_NO = "serviceFunctionNo";

    //放款人
    public final static String PARAM_BUILDER_CODE = "builderCode";
    public final static String PARAM_BUILDER_NAME = "builderName";
    public final static String PARAM_LOANER = "loaner";

    //接收邮件地址
    public final static String PARAM_MAIL_RECEIVER_ADDRESS = "mailReceiverAddress";
    //抄送邮件地址
    public final static String PARAM_MAIL_CC_ADDRESS = "mailCcAddress";
    //短信接收号码
    public final static String PARAM_SHORT_MSG_RECEIVER = "shortMsgReceiver";
    //微信消息接收号码
    public final static String PARAM_WECHAT_RECEIVER = "wechatReceiver";
    //是否借款合同类型标识
    public final static String PARAM_LOAN_CONTRACT_FLAG = "loanContractFlag";


    //外部机构代码
    public final static String PARAM_EXTERNAL_INSTITUTIONS_LIST = "externalInstitutionsList";
    public final static String PARAM_EXTERNAL_INSTITUTIONS_CODE = "externalInstitutionsCode";
    public final static String PARAM_EXTERNAL_INSTITUTIONS_NAME = "externalInstitutionsName";
    public final static String PARAM_EXTERNAL_INSTITUTIONS_TYPE = "externalInstitutionsType";
    public final static String PARAM_BUILDER_GROUP_CODE = "builderGroupCode";
    public final static String PARAM_BUILDER_GROUP_NAME = "builderGroupName";
    //业务编号
    public final static String PARAM_LOAN_ID = "loanId";
    public final static String PARAM_BUSINESS_ID = "businessId";
    //请求方代码
    public final static String PARAM_SOURCE_SYSTEM = "sourceSystem";
    //待生成合同列表
    public final static String PARAM_MODEL_LIST = "modelList";
    public final static String PARAM_ATTACH_FILE_LIST = "attachFileList";
    public final static String PARAM_CONTRACT_LIST = "contractList";

    //信息发送结果
    public final static String PARAM_SEND_RESULT = "sendResult";
    //信息发送状态
    public final static String PARAM_SEND_STATUS = "sendStatus";
    //信息发送方式
    public final static String PARAM_SEND_TYPE = "sendType";
    //文件生成结果
    public final static String PARAM_CREATE_RESULT = "createResult";

    //参数
    public final static String PARAM_PARAMS = "params";
    public final static String PARAM_REQUIRED_PARAM = "requiredParam";
}

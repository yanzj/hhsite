...
public class BuildFileByModelService extends QuartzService {
    ...
    public void subExcute() throws Exception {
        ...
        //fmsBuildModelRecords.setSerialNo("FBMR-201708052039224758623");
        ...
        if (fmsBuildModelRecordsList != null && fmsBuildModelRecordsList.size() > 0) {
            ...
            for (FmsBuildModelRecords fbmr : fmsBuildModelRecordsList) {
                ...
                if (Constants.OUT_SEND_STATUS_DOING.equals(fbmr.getSendStatus())) {
                    ...
                    JSONArray originalOutFileArray = JSONArray.fromObject(originalOutFileStr);
                    ...
                    try {
                        ...
                        if (zipFileMap != null) {
                            ...
                            if (bodyZipFileMap != null) {
                                ...
                                sendFileMap.put("urlFileName", bodyZipFileMap.get("fileName"));
                                ...
                                fmsSendFiles.setFileId(bodyZipFileMap.get("serialNo") == null ? "" : bodyZipFileMap.get("serialNo").toString());
